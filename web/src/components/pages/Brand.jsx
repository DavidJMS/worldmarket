...
class Brand extends React.Component {
    ...
    handlerDelete = (elemento) =>{
        this.setState({brandId:elemento},
            this.fetchDelete);
    }

    fetchDelete = async () =>{
        const id = this.state.brandId

        fetch(`http://127.0.0.1:8000/api/brand/${id}/`,{
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                Authorization:`Token ${this.props.token}`
                ...
                <div className="col-12">
                    <div className="card">
                        <div className="card-header">
                            <h3 className="text-center">Marcas</h3>
                            <Link to={"brand/new"}>
